    ...
    dashboardBody(VisionHeader(),
                  ...
                  tabItems(
                    tabItem(tabName = "intro",
                            ...
                            fluidRow(
                              column(4,box(title = "Modelos Lineales Generales GLM" ,width = 112,background="yellow","El modelo lineal 
                                           ...
                                           normal. El modelo lineal generalizado cubre los modelos estadísticos más utilizados, como 
                    ...
                    tabItem(tabName = "subitem1",
                           ...
                           fluidRow(
                             box(title = h3("Prueba de hipotesis de normalidad"), style = "overflow-x:scroll",width=12,status = "warning",dataTableOutput('datatable123'))
                           ),
                           fluidRow(
